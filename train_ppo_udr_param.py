...
def main():
    ...
    for param in params:
        ...
        if ppo_policy:
            ...
            if training:
                ...
                # del model #this only if we have trained a model in this script and we want to delete it
                model = PPO.load("ppo_hopper") #sac_hopper for the source environment else sac_hopper_target
    ...
    def print_plot_rewards(rewards,title):
        ...
        with open(f"output_source_target_ppo_UDR_param_{param}.txt", "w") as file: #change the name of the file when evaluating
